...
players=("bitmovin" "dashjs" "dashjs4" "dashjs4TV" "dashjs4Desktop" "dashjs4Mobile" "dashjscmcdTV" "dashjscmcdDesktop" "dashjscmcdMobile" "shaka" "bola" "bba0" "elastic" "fastmpc" "quetra")
experiments=1
